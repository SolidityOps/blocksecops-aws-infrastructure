# Outputs for Production State Backend Configuration
...
output "backend_config" {
  ...
  value       = module.state_backend.backend_config_production
}
...
output "setup_instructions" {
  ...
  value = <<-EOT
    ...
    To use this backend for production networking:
    ...
    - State Key: networking/production/terraform.tfstate
  EOT
}

# Summary for production environment
output "summary" {
  description = "Summary of the production state backend deployment"
